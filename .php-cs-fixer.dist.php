...
$config = (new PhpCsFixer\Config())
	...
	->setRules([
		...
		// CustomFixer\CommentedOutFunctionFixer::name() => false,
		...
		CustomFixer\NoLeadingSlashInGlobalNamespaceFixer::name() => true,
		// CustomFixer\NoNullableBooleanTypeFixer::name() => false,
		// CustomFixer\NoPhpStormGeneratedCommentFixer::name() => false,
		// CustomFixer\NoReferenceInFunctionDefinitionFixer::name() => false,
		CustomFixer\NoSuperfluousConcatenationFixer::name() => true,
		CustomFixer\NoTrailingCommaInSinglelineFixer::name() => true,
		// CustomFixer\NoUselessCommentFixer::name() => false,
		// CustomFixer\NoUselessDirnameCallFixer::name() => false,
		// CustomFixer\NoUselessDoctrineRepositoryCommentFixer::name() => false,
		...
		// CustomFixer\PhpdocArrayStyleFixer::name() => false,
		// CustomFixer\PhpdocNoIncorrectVarAnnotationFixer::name() => false,
		CustomFixer\PhpdocNoSuperfluousParamFixer::name() => true,
		// CustomFixer\PhpdocOnlyAllowedAnnotationsFixer::name() => false,
		// CustomFixer\PhpdocParamOrderFixer::name() => false,
		...
		// CustomFixer\PromotedConstructorPropertyFixer::name() => false,
		// CustomFixer\ReadonlyPromotedPropertiesFixer::name() => false,
		// CustomFixer\SingleSpaceAfterStatementFixer::name() => false,
